...
export default function HeroSection() {
  const [ref, inView] = useInView({
    triggerOnce: false, // every time the section comes into view
    threshold: 0.2,
  });
  ...
  return (
    <section ref={ref} className="flex flex-col md:flex-row items-center justify-center px-4 md:px-16 py-12 bg-white">
      {/* Left Image */}
      <motion.div
      ...
      >
        <p className="text-sm text-gray-500 font-medium mb-2">🌱 FRESH FROM OUR FARM</p>
        <h1 className="text-4xl md:text-5xl font-bold text-gray-800 leading-tight">
          Trusted Organic Food <br />
          Store Conscious
        </h1>
        <p className="italic text-lg text-gray-600 mt-4">
