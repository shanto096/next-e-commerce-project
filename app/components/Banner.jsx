...
export default function HeroSection() {
  ...
  return (
    ...
    >
      <section
        ref={ref}
        className="flex flex-col md:flex-row items-center md:items-start justify-between gap-10 px-4 md:px-16 py-12 transition-colors duration-500"
      >
        {/* Left Image */}
        <motion.div
        ...
        >
          <p className="text-sm font-medium mb-2">🌱 FRESH FROM OUR FARM</p>
